...
public class Game {
	...
	private class GameController {
		...
		public void beginObjectInteraction() {
			switch (attemptObject.getMessage()) {
			case CREATE_WELCOME_AND_DESCRIPTION_MESSAGE:
				messageManagerObject.createWelcomeAndDescriptionMessage();
				break;
			default:
				System.out.println("error in beginObjectInteraction()");
	...
	public void startGame(Game newGame) {
		...
		gameController.beginObjectInteraction();
