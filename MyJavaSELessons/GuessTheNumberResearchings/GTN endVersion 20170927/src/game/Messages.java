...
public class Messages {
	...
	public final static String WELCOME_MESSAGE =
			...
			+ "Угадайте цифру от 1 до 9 включительно.";
	public final static String YOU_HAVE_SOME_ATTEMPTS_MESSAGE =
			"У Вас есть всего три попытки.";
	public final static String ATTEMPT_LEFT_MESSAGE = 
			"У Вас осталось %d попыток.";
	public final static String ATTEMPT_NUMBER_MESSAGE = 
			"Попытка № %d. ";
	...
	public final static String YOU_ARE_WINNER_FROM_ATTEMPT_MESSAGE = 
			"Вы победили! Угадали с %d" + /*ATTEMPT + */" попытки цифру %d" +
			/*ENTERED NUMBER + */".";
	...
	public final static String NUMBER_IS_SMALLER_OR_LAGER_MESSAGE = 
			"Введенная Вами цифра %s искомой цифры.";
	public final static String LAGER_MESSAGE = 
			"больше";
	public final static String SMALLER_MESSAGE = 
			"меньше";
	...
	public final static String GUESSED_NUMBER_WAS_MESSAGE = 
			"Отгадываемая цифра была %d" + /*numbertoguess + */".";
