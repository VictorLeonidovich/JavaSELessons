...
BUILDER(SimpleRobotType.BUILDER, "build", 0L, 0L, new ConcurrentLinkedDeque<Task>()),
DESTROYER(SimpleRobotType.DESTROYER, "destroy", 0L, 0L, new ConcurrentLinkedDeque<Task>()),
KILLER(SimpleRobotType.KILLER, "kill", 0L, 0L, new ConcurrentLinkedDeque<Task>()),
DEFENDER(SimpleRobotType.DEFENDER, "defend", 0L, 0L, new ConcurrentLinkedDeque<Task>())/*
																 * , ALL(
																 * "killyourself",
																 * 0L, 0L, new
																 ...
																 * <Task>())
																 */;
	private volatile SimpleRobotType simpleRobotType;
	...
	private RobotType(SimpleRobotType simpleRobotType, String mission, long robotsAmount, long tasksAmount,
			Deque<Task> tasksStorage) {
		this.simpleRobotType = simpleRobotType;
	...
	public SimpleRobotType getSimpleRobotType() {
		return simpleRobotType;
	}
