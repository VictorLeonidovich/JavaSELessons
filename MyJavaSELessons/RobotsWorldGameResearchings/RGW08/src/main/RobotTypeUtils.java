...
BUILDER(RobotTypeTarget.BUILDER, "build", 0L, 0L, new ConcurrentLinkedDeque<Task>(), new CopyOnWriteArrayList<Robot>()),
DESTROYER(RobotTypeTarget.DESTROYER, "destroy", 0L, 0L, new ConcurrentLinkedDeque<Task>(), new CopyOnWriteArrayList<Robot>()),
KILLER(RobotTypeTarget.KILLER, "kill", 0L, 0L, new ConcurrentLinkedDeque<Task>(), new CopyOnWriteArrayList<Robot>()),
DEFENDER(RobotTypeTarget.DEFENDER, "defend", 0L, 0L, new ConcurrentLinkedDeque<Task>(), new CopyOnWriteArrayList<Robot>());
	...
	private RobotTypeUtils(RobotTypeTarget robotTypeTarget, String mission, long robotsAmount, long tasksAmount,
