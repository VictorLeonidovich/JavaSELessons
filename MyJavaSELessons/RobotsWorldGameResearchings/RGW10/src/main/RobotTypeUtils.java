...
public enum RobotTypeUtils {
	BUILDER(RobotTypeTarget.BUILDER, Mission.BUILD, 0L, 0L, new ConcurrentLinkedDeque<Task>(),
			new CopyOnWriteArrayList<Robot>()), DESTROYER(RobotTypeTarget.DESTROYER, Mission.DESTROY, 0L, 0L,
					new ConcurrentLinkedDeque<Task>(), new CopyOnWriteArrayList<Robot>()), KILLER(
							RobotTypeTarget.KILLER, Mission.KILL, 0L, 0L, new ConcurrentLinkedDeque<Task>(),
							new CopyOnWriteArrayList<Robot>()), DEFENDER(RobotTypeTarget.DEFENDER, Mission.DEFEND, 0L,
